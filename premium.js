...
function ispremium(premium) {
    if (premium === false) {
        alert("Funcionalidade restrita a premium!")
...
window.onload = () => {
    reply("Olá, precisa de ajuda? NAo se esqueça da sua consulta dia 31 de Janeiro ás 17,30h!")
}
